...
function OAuth2Button() {
    return (
        ...
        <div className="grid grid-cols-2 gap-4" >
            ...
            <NavLink
                to={`${import.meta.env.VITE_BASE_URL || "https://auth-backend-1-0.onrender.com"}/oauth2/authorization/google`}
                className="block"
            >
                <Button
                    type="button"
            ...
            <NavLink
                to={`${import.meta.env.VITE_BASE_URL || "https://auth-backend-1-0.onrender.com"}/oauth2/authorization/github`}
                className="block"
            >
                <Button
